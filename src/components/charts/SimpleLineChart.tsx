...
export const SimpleLineChart: React.FC = () => (
  <svg viewBox="0 0 500 200" className="w-full h-full overflow-visible">
    ...
    <path d="M0 120 L100 100 L200 110 L300 90 L400 100 L500 80" fill="none" stroke="#9CA3AF" strokeWidth="2" strokeDasharray="5 5" strokeOpacity="0.5" />
    <path d="M0 130 L100 90 L200 120 L300 60 L400 80 L500 40 L500 200 L0 200 Z" fill="url(#actualGradient)" stroke="none" />
    <path d="M0 130 L100 90 L200 120 L300 60 L400 80 L500 40" fill="none" stroke="#EA580C" strokeWidth="3" />
    {[130, 90, 120, 60, 80, 40].map((y, i) => (
      <circle key={i} cx={i * 100} cy={y} r="4" fill="white" stroke="#EA580C" strokeWidth="2" />
    ))}
