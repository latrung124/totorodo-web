...
export const HISTORY_TASKS: HistoryTask[] = [
  { id: 101, icon: <Flag size={16}/>, name: "Read Chapter 1", pomodoros: 4, time: "100 mins", deadline: "20/11/2025", date: "20/11/2025", status: "done" },
  { id: 102, icon: <Edit3 size={16}/>, name: "Write Essay Draft", pomodoros: 3, time: "75 mins", deadline: "21/11/2025", date: "21/11/2025", status: "done" },
  { id: 103, icon: <Layers size={16}/>, name: "Design System Update", pomodoros: 6, time: "150 mins", deadline: "19/11/2025", date: "22/11/2025", status: "late" },
];
